...
public sealed class PasswordServiceTests
{
    ...
    public async Task ConfiguringTwiceIsAConflict()
    {
        ...
        var second = await Service.ConfigureAsync("otra-contrasena-larga", CancellationToken.None);
    ...
    public async Task ChangingThePasswordRotatesTheSecurityStamp()
    {
        ...
        var result = await Service.ChangeAsync(Password, "otra-contrasena-larga", CancellationToken.None);
        ...
        Assert.True((await Service.ValidateAsync("otra-contrasena-larga", CancellationToken.None)).IsSuccess);
    }
    ...
    public async Task ChangingWithTheWrongCurrentPasswordChangesNothing()
    {
        ...
        var result = await Service.ChangeAsync("no-es-la-buena", "otra-contrasena-larga", CancellationToken.None);
